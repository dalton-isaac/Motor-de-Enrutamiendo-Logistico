...
public class LogiPackTest {
    ...
    public static void main(String[] args) {
        ...
        // 1. Quito (0) -> Cuenca (4) = 370 km (Quito -> Ambato -> Cuenca)
        ...
        // 4. Ambato (3) -> Guayaquil (2) = 415 km (Ambato -> Cuenca -> Guayaquil: 220 +
        // 195 = 415)
        verificar(solver.calcularRutaOptima(grafo, 3, 2), 415, "Ambato -> Cuenca -> Guayaquil", "Ambato a Guayaquil");

        // 5. Cuenca (4) -> Manta (1) = 385 km (Cuenca -> Guayaquil -> Manta: 195 + 190
        // = 385)
